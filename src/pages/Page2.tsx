...
import FlightSearch from '../components/FlightSearchCard';

// Import komponen dari Fahdil (Upstream)
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA]">
      ...
      <main className="w-full font-sans">
        ...
        {/* --- BAGIAN FAHDIL (Gabungan SEO & Konten Tambahan) --- */}
        <div className="w-full bg-[rgb(237,240,247)] pt-8 pb-1">
          <div className="max-w-[1080px] mx-auto px-4 md:px-0">
            ...
            <div className="my-10"> {/* Disesuaikan agar tidak terlalu renggang */}
              <CheckInGrid />
            </div>
