...
const RecentSearch = () => {
  ...
  return (
    <div className="bg-[rgb(237,240,247)] pb-10">
      ...
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar relative">
          {searches.map((item, index) => (
            <div
              key={index}
              className="min-w-[380px] bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex items-center justify-between cursor-pointer hover:shadow-md transition-shadow"
            >
