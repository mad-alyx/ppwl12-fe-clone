...
const Navbar = () => {
  return (
    <header className="w-full bg-white font-sans">
      ...
      <div className="bg-[rgb(237,240,247)] py-2 px-4 border-b border-gray-200">
      ...
      <div className="bg-white py-5 px-4 shadow-sm">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 shrink-0">
            ...
            <div className="relative w-full max-w-[280px]">
              ...
              <input
                ...
                className="w-full bg-[rgb(237,240,247)] pl-11 pr-4 py-2.5 rounded-full text-sm focus:outline-none focus:ring-1 focus:ring-blue-400 text-gray-700"
              />
            </div>
          </div>
          ...
          <nav className="flex items-center space-x-1">
            <button className="px-4 py-2 bg-[#f1f5ff] text-[#0064d2] font-bold rounded-full text-[14px]">
              Pesawat
            </button>
            <button className="px-4 py-2 text-[#58627a] font-bold hover:bg-gray-100 rounded-full text-[14px]">
              Hotel
            </button>
            <button className="px-4 py-2 text-[#58627a] font-bold hover:bg-gray-100 rounded-full text-[14px]">
              Vila & Apt.
